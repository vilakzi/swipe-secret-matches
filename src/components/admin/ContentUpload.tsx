...
const ContentUpload = () => {
  ...
  const uploadSingleFile = async (uploadFile: UploadFile) => {
    ...
    await createContent({
      ...
      status: 'published', // Automatically publish content
      visibility: 'public',
      published_at: new Date().toISOString(), // Set publish timestamp
      metadata: {
        originalName: uploadFile.file.name,
        uploadedAt: new Date().toISOString(),
        autoGenerated: true, // Flag to indicate this creates a profile card
      },
    });
  };
